...
?>
<!-- Page Header Start -->
<div class="container-fluid page-header-despensa wow fadeIn" data-wow-delay="0.1s">
    <div class="container">
        <h1 class="display-3 mb-3 animated slideInDown">Despensa</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item text-dark active" aria-current="page">Despensa</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                    <h1 class="display-5 mb-3">Despensa</h1>
