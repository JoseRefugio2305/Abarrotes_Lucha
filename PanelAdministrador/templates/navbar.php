...
<html lang="en">
    <head>
        ...
        <title>Administrador - Abarrotes Lucha</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <!-- navbar-dark bg-dark -->
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">"Lucha"</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href=".././">Regresar a Pagina Principal</a></li>
